...
- Las notas del drawer son privadas por administrador: solo su autor puede consultarlas o modificarlas y esta restricción debe aplicarse también en backend. Se presentan como texto simple con fecha y una acción explícita de edición; el `TextArea` solo aparece al añadir o editar. La vista inicial muestra como máximo las tres notas más recientes. Cuando existen más, “Ver todas (N)” abre una lista paginada con altura limitada y scrollbar; guardar o editar utiliza los alerts compartidos de éxito y error.
