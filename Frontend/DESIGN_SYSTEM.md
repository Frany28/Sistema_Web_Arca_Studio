...
- Proyectos destacados sigue a Servicios dentro de Home (`#featured-projects`). Su primer contenedor corresponde a Figma `4856:5032`: encabezado, nombre Quinta Bella Vista y descripción, con padding de 48 px, separación de 24 px y descripción limitada a 520 px. Entra vacío y el siguiente gesto revela sus líneas con SplitText, recalculadas al cambiar el ancho o cargar fuentes; movimiento reducido muestra el texto inmediatamente. No se puede salir por scroll hasta completar el revelado. El navbar indica la sección activa y permite saltar directamente, incluso durante otra transición. Servicios debe completar sus categorías antes de pasar por scroll a Proyectos destacados; regresar conserva el progreso de Servicios. Los demás contenedores de proyectos siguen pendientes de diseño.
