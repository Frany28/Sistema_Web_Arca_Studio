...
- Servicios y el encabezado de Proyectos destacados forman un flujo de scroll nativo continuo, sin saltos por sección ni obligación de recorrer categorías. El primer contenedor de Servicios conserva la máscara compartida de aparición al entrar en pantalla, sin bloquear el scroll; movimiento reducido lo muestra directamente. Únicamente el segundo contenedor de Servicios aparece desde el montaje sin revelado. El encabezado de Proyectos permanece visible. El selector cambia categorías por clic o teclado y deja pasar rueda y touch. La categoría seleccionada se conserva al desplazarse entre secciones.
...
- La introducción y el video conservan sus pasos y bloqueos originales. Al regresar por scroll continuo hasta el inicio del video se restablece su controlador. Ctrl+rueda conserva el zoom y el foco de teclado mantiene visible el navbar. La ruta `/servicios` sigue redirigiendo a `/#services`.
