...
- El modal “Nuevo usuario” mantiene sus acciones en un footer separado por un borde superior. “Cancelar” usa `Button` primario `Outline` y “Enviar código de activación” usa `Button` primario `Solid`; ambos ocupan el mismo ancho con `16px` de separación en escritorio y se apilan a ancho completo en móvil.
