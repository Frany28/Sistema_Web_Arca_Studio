...
- En Servicios y Proyectos destacados, el padding superior de sección usa `--spacing-gap-9`. El primer contenedor de Servicios conserva su padding original de 48 px verticales (`--spacing-gap-7`) y horizontales desde tablet; el encabezado de Proyectos usa `--spacing-gap-8`. En móvil conservan 16 px horizontales. Servicios usa `--spacing-gap-8` entre sus contenedores y al final de la sección; el layout del selector usa ese mismo token en escritorio, conservando sus ajustes compactos de tablet y móvil. Los gaps internos de 24 px entre textos permanecen independientes del padding de sección.

- Servicios y el encabezado de Proyectos destacados forman un flujo de scroll nativo continuo, sin saltos por sección ni obligación de recorrer categorías. El primer contenedor de Servicios y el encabezado de Proyectos destacados conservan la máscara compartida de aparición al entrar en pantalla, una vez y sin bloquear el scroll; movimiento reducido los muestra directamente. Únicamente el segundo contenedor de Servicios aparece desde el montaje sin revelado. El selector cambia categorías por clic o teclado y deja pasar rueda y touch. La categoría seleccionada se conserva al desplazarse entre secciones.
