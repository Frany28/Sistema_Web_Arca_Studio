...
- Servicios y el encabezado de Proyectos destacados forman un flujo de scroll continuo sin saltos por sección. El primer contenedor de Servicios conserva la máscara compartida de aparición al entrar en pantalla y se rearma al salir; observa un contenedor sin recorte y anima su contenido interior para evitar que la máscara impida detectar su visibilidad. El encabezado de Proyectos conserva su aparición. Movimiento reducido muestra directamente los textos. Únicamente el segundo contenedor de Servicios aparece desde el montaje sin revelado: su recorrido interno por rueda y touch permanece activo, manteniendo la posición mientras cambian categoría, imagen e indicador. Tras completar todas las categorías, un nuevo gesto descendente libera el scroll; subir desde la primera categoría permite volver hacia el video. Clic y teclado siguen disponibles, y la selección se conserva al desplazarse entre secciones.
