...
- La navegación por rueda, touch, teclado y scrollbar no permite abandonar la sección actual mientras tenga pasos de scroll pendientes. Seleccionar un área en el navbar es una excepción: desplaza directamente al destino y puede interrumpir una transición en curso. En Servicios, un gesto ascendente oculta los contenedores en orden inverso y espera cada transici?n antes de retroceder; el scrollbar no puede omitir la introducción ni dar por completado el efecto del video.
