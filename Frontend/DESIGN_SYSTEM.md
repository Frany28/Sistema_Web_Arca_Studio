...
- La galería de Quinta Bella Vista conserva sus seis imágenes, geometría y máscara de aparición compartida. Se revela una vez cuando entra en el viewport y no bloquea ni reposiciona el scroll. El navbar actualiza la sección activa por la posición real del contenido y mantiene la navegación directa.
