...
function PlaybackBar() {
  return (
    <div className="absolute inset-x-[16px] bottom-[12px]">
      <div className="relative h-[8px] w-full overflow-hidden rounded-[var(--radius-full,999px)] bg-[var(--color-neutral-200)]">
        <div className="absolute left-0 top-1/2 h-[8px] w-[12%] -translate-y-1/2 rounded-full bg-[var(--color-text-300)]" />
      </div>
      ...
      <div className="mt-[8px] flex items-center justify-between">
        <Button
          ...
          showLeftIcon
          showRightIcon={false}
          iconLeft={<VolumeIcon className="size-5" />}
          aria-label="Volumen"
          className="shrink-0"
        />
        ...
        <Button
          ...
          showLeftIcon
          showRightIcon={false}
          iconLeft={<SettingsIcon className="size-5" />}
