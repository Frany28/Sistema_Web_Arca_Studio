...
test("services navigation scrolls within Home and preserves its responsive heading", () => {
  ...
  assert.match(servicesHeadingSource, /data-node-id="4848:8082"/);
  ...
  assert.match(servicesHeadingSource, /<SectionTitleReveal/);
  assert.doesNotMatch(servicesHeadingSource, /getSectionRevealClip|whileInView/);
  ...
  assert.doesNotMatch(servicesHeadingSource, /SplitText|useServicesHeadingReveal/);
  ...
  assert.match(
    movingGradientTitleStyles,
    /\.services-moving-gradient-title \.services-heading-line/,
  );
  ...
  assert.match(movingGradientTitleStyles, /services-title-gradient-flow 15s ease-in-out infinite/);
  assert.match(movingGradientTitleStyles, /linear-gradient\(\s*110deg/);
  assert.match(movingGradientTitleStyles, /#fff 38%/);
  assert.match(movingGradientTitleStyles, /#ff4431/);
  assert.match(movingGradientTitleStyles, /#5e302d/);
  assert.match(movingGradientTitleStyles, /background-size: 300% 100%/);
